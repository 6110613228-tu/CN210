...
0100000C:    00221820    0000 0000 0000 0010 0001 1000 0010 0000  -> ที่ตำแหน่งนี้000000 opcode ของ R-type ต้องไปดูที่ Funct จึงจะทราบได้ว่าเป็นคำสั่งให้ทำอะไร  
01000010:    AD230008    1010 1101 0010 0011 0000 0000 0000 1000
...
1A000000:    0000000A    0000 0000 0000 0000 0000 0000 0000 1010
1A000004:    00000014    0000 0000 0000 0000 0000 0000 0001 0100
...
```
 ...
 สังเกตุตำแหน่งของ Memory จะเปลี่ยนไปทีละ 32 bits เนื่องจากแต่ละชุดคำสั่งมีขนาด 32 bits พอดี
